...
class App
  ...
  def creating_trains #Создание поезда
    ...
    puts "Добавьте производителя поезда."
    manufacturer = gets.chomp.capitalize
    train = find_train(num)

    return unless train

    train.manufacturer_name = manufacturer
    puts "Производитель поезда #{num}, является #{manufacturer}"
  ...
  def creating_wagons #Создание вагонов
    ...
    puts "Добавьте производителя вагона."
    manufacturer = gets.chomp.capitalize
    wagon.manufacturer_name = manufacturer
    puts "Производитель вагона #{wagon.type}, является #{manufacturer}"
  ...
  def wagon_instances
    PassengerWagon.instance
    CargoWagon.instance
  end

  def train_instances
    PassengerTrain.instance
    CargoTrain.instance
  end
